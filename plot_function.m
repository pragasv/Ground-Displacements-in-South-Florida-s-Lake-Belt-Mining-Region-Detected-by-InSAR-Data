...
% data = readtable('preprocessed_output_90_random.csv', 'Format','%f%s%f%f%f%f');
% data = readtable('preprocessed_output_95_random.csv', 'Format','%f%s%f%f%f%f');
data = readtable('preprocessed_output_99_random.csv', 'Format','%f%s%f%f%f%f');
